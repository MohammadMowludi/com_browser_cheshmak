# com_browser_cheshmak Privacy Policy   com.browser.cheshmak  browser cheshmak
## Privacy Policy

#cheshmakfreeapp built the #browser #cheshmak app as an Ad Supported app. This SERVICE is provided by #cheshmakfreeapp at no cost and is intended for use as is.
...
The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible
                    at #browser #cheshmak unless otherwise defined in this Privacy Policy.
...
This application uses memory access to store and retrieve pictures.
This application uses phone access to set best setting and ui for best performancy.
